...
if __name__ == "__main__":
    main()
    #text to speach starts here
    url ='https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/a60b6a76-2ca2-46a7-9b34-94581c5d8e0f'
apikey='4762fSiqpxkMJSfAxvpKFiKq7jxBMI27UDR8aCGz0X_u'
...
with open('output.txt', 'r') as f:
    ...
    with open('./outputAudio.mp3', 'wb') as audio_file:
